...
const Home=(props) => {
 ...
 <div className='main-content' style={{color: '#000'}}>
  ...
  overflow: "hidden"
                  ...
                  >
            <button className="button" onClick={() => props.selectedTemHandler(index)}>Use Template</button>
          </div>
                </Grid>
 ...
 <Grid container  alignItems="flex-end" style={{alignItems:'end'}}>
      ...
      <Grid item md={11} lg={11} style={{ marginTop: '15px' ,  textAlign:"end" }}>
          <Stack
      spacing={2}
      direction="row"
    ...
    >
        ...
        >
         Proceed to Fill Details <ArrowForwardIcon style={{paddingLeft: '5px'}}/>
        </ColorButton>
    </Stack>
